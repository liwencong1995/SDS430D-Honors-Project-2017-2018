...
```
Each one percent increase in average tips in pick-up zones is associated with 18382.03 increase in the number of trips per month, controlling the pick-up zone. 
...
593/320718
```
In August 2016, yellow cabs made an average of 320,718 daily trips. Additionally, each one percent increase in average tips in pick-up zones is associated with 593 increase in the number of trips per day in a specific pick-up zone.
