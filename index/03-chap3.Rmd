...
yellow_2017_2 <- taxi %>%
  ...
  filter(month(tpep_pickup_datetime)) %>%
  collect(n = Inf)
```
...
```{r pickup-vis, fig.cap = "Percent Tip Paid by Passengers on Each Pick-up Taxi Zone in NYC", echo=FALSE}
...
```{r tip-region, fig.cap="Percent Tip Paid by Passengers on Each Pick-up And Drop-off Pair in NYC", echo=FALSE}
...
#library(htmlwidgets)
saveWidget(num_trip, file = "/Users/priscilla/Desktop/Honors Thesis/writing/figures/num_trip.html")
URL <- "/Users/priscilla/Desktop/Honors Thesis/writing/figures/num_trip.html"
