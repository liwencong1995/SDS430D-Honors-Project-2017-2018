...
Since we are using all 12 month data from 2017 in this analysis, it is impossible to load all data needed into R environment. Instead, we want to only load a summary table from MySQL database. 
```{r}
yellow_2017 <- taxi %>%
  tbl("yellow") %>%
...
```{r num-trip, fig.cap="Number of Pick-ups in Each Taxi Zone", fig.align='center', echo=FALSE, fig.width=6, fig.height=6}
