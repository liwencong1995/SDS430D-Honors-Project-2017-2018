...
```{r pickup_vis, fig.cap="Percent Tip Paid by Passengers on Each Pick-up Taxi Zone in NYC"}
...
```{r tip_region, fig.cap="Percent Tip Paid by Passengers on Each Pick-up And Drop-off Pair in NYC"}
...
# 10 Taxi zone with the highest percent tip, threshold is 900
```
...
# Ten Taxi zone with the highest percent tip, threshold is 90000
```
