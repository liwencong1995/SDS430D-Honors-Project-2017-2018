...
```{r, message=FALSE, echo=FALSE}
kable(tip_pickup_1[1:10,c(4, c(8:9,4))],
...
kable(tip_pickup_zone[1:10,c(2, c(6,7,3))], 
...
```{r, echo=FALSE}
kable(pickup_zone_24[1:10, c(2, c(6,7,2))], caption = "Ten taxi pick-up zones with the highest percent tip (taxi zones has at least 1 pick-up per hour)",
      format = "latex",
      align = 'c', 
      escape = TRUE,
      booktabs = TRUE
...
```{r, echo=FALSE}
kable(pickup_zone_60[1:10, c(2, c(6,7,2))], caption = "Ten taxi pick-up zones with the highest percent tip (taxi zones has at least 1 pick-up per minute)",
      format = "latex",
      align = 'c', 
      escape = TRUE,
      booktabs = TRUE)
