...
install (Li, Baumer, \& Trang Le, 2017), and the source code for data
...
from 2016 to the most recent week (Li et al., 2017).
...
impossible to load all data needed into \textbf{R} environment. Instead,
we want to only load a fraction of the 2017 Yellow Taxi data from MySQL
database.
