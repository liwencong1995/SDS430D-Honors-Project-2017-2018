...
\caption{\label{tab:unnamed-chunk-16}Ten taxi pick-up zones with the highest percent tip with threshold equals to 90000}
\centering
\begin{tabular}[t]{r|r|r|r|l|l}
\hline
LocationID & avg\_tip & num\_trips & avg\_dis & Borough & Zone\\
...
\caption{\label{tab:unnamed-chunk-24}Pick-up Zones with avergae fare to JKF Airport}
\centering
\begin{tabular}[t]{r|r|r|r|l|l}
\hline
