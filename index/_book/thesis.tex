...
\KeywordTok{kable}\NormalTok{(tip_pickup[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, ])}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/pickup_vis-1.pdf}
...
\end{verbatim}
\includegraphics{thesis_files/figure-latex/tip_region-1.pdf} The 20\%
...
\KeywordTok{kable}\NormalTok{(pickup_zone_}\DecValTok{900}\NormalTok{[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, ])}
\end{Highlighting}
\end{Shaded}
\begin{tabular}{r|r|r|r|l|l}
\hline
...
\KeywordTok{kable}\NormalTok{(pickup_zone_}\DecValTok{90000}\NormalTok{[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, ])}
\end{Highlighting}
\end{Shaded}
\begin{tabular}{r|r|r|r|l|l}
\hline
...
\caption{\label{tab:unnamed-chunk-21}Pick-up Zones with avergae fare to JKF Airport}
\centering
