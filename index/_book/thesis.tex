...
\caption{\label{tab:unnamed-chunk-91}Ten pick-up zones with the highest avergae fare from Manhattan to JFK Airport}
\centering
...
\end{figure}
According to the Figure @\ref(fig:from-jfk-num-trips), Manhattan is the
most popular destination for passengers departing from JFK Airport.
\begin{table}

\caption{\label{tab:unnamed-chunk-101}Number of Trips going to Manhattan or other boroughs from JFK Airport}
\centering
\begin{tabular}[t]{cc}
\toprule
...
Manhattan is about 0.6504482\% of the total number of trips travelling
from JFK Airport to all other Borough. Therefore, it is very likely for
taxi drivers to get passengers who want to go to Manhattan with a flat
rate of \$52.
...
\caption{\label{tab:unnamed-chunk-103}10 most popular taxi drop-off zones from JFK Airport with the corresponding average fare amount}
\centering
\begin{tabular}[t]{ccccc}
\toprule
...
{\centering \includegraphics[width=5.84in]{figure/from_jfk_fare_vis} 
