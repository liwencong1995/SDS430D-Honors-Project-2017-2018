...
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/unnamed-chunk-4-1.png}
...
\caption{\label{tab:unnamed-chunk-23}Ten taxi pick-up zones with the highest percent tip with threshold equals to 90000}
\centering
\begin{tabular}[t]{r|r|r|r|l|l}
\hline
LocationID & avg\_tip & num\_trips & avg\_dis & Borough & Zone\\
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# library(dplyr) library(readr) library(lubridate)}
...
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/unnamed-chunk-33-1.pdf} As
...
No trace type specified:
  ...
  Read more about this trace type -> https://plot.ly/r/reference/#scatter
\end{verbatim}
\includegraphics{thesis_files/figure-latex/unnamed-chunk-38-1.pdf} As
