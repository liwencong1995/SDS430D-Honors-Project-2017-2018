...
\section{Appendix A: Utility
Function}\label{appendix-a-utility-function}
...
\end{Highlighting}
\end{Shaded}
\section{Appendix B: Data Dictionary -- Yellow Taxi Trips
Records}\label{appendix-b-data-dictionary-yellow-taxi-trips-records}
\begin{figure}
  \centering
...
\end{figure}
\section{Appendix C: FOIL Request}\label{appendix-c-foil-request}
\begin{figure}
  \centering
  \includegraphics[width=6in]{figure/appendix_foil_form_doc.pdf}
  \caption{FOIL Request}
\end{figure}
\section{Appendix D: NOAA Climate Data
Request}\label{appendix-d-noaa-climate-data-request}
\begin{figure}
  \centering
