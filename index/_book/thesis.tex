...
\KeywordTok{kable}\NormalTok{(tip_pickup[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, ], }\DataTypeTok{caption =} \StringTok{"Ten taxi pick-up zones with the highest average tip without any threshold"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{table}

\caption{\label{tab:unnamed-chunk-13}Ten taxi pick-up zones with the highest average tip without any threshold}
\centering
...
\begin{figure}
\centering
\includegraphics{thesis_files/figure-latex/pickup-vis-1.pdf}
...
\end{verbatim}
\includegraphics{thesis_files/figure-latex/tip-region-1.pdf} The 20\%
...
\CommentTok{# create visulization leaflet(data = pick_up_zones)}
\CommentTok{# %>% addTiles() %>% addPolygons(fillColor =}
\CommentTok{# ~reds(num_trips), fillOpacity = 0.6, weight = 1,}
\CommentTok{# opacity = 0.8) %>% setView(lat = 40.7128, lng =}
\CommentTok{# -74.0060, zoom = 10) library(htmlwidgets)}
\CommentTok{# saveWidget(m, file =}
\CommentTok{# '/Users/priscilla/Desktop/Honors}
\CommentTok{# Thesis/writing/figures/temp.html') URL <-}
\CommentTok{# '/Users/priscilla/Desktop/Honors}
\CommentTok{# Thesis/writing/figures/temp.html' webshot(URL,}
\CommentTok{# cliprect = 'viewport')}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# pickup_zone_900 %>% head(10)}
\KeywordTok{kable}\NormalTok{(pickup_zone_}\DecValTok{900}\NormalTok{[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, ], }\DataTypeTok{caption =} \StringTok{"Ten taxi pick-up zones with the highest percent tip with threshold equals to 900"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{table}

\caption{\label{tab:unnamed-chunk-16}Ten taxi pick-up zones with the highest percent tip with threshold equals to 900}
\centering
\begin{tabular}[t]{r|r|r|r|l|l}
\hline
LocationID & avg\_tip & num\_trips & avg\_dis & Borough & Zone\\
...
\CommentTok{# pickup_zone_90000 %>% head(10)}
\KeywordTok{kable}\NormalTok{(pickup_zone_}\DecValTok{90000}\NormalTok{[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, ], }\DataTypeTok{caption =} \StringTok{"Ten taxi pick-up zones with the highest percent tip with threshold equals to 90000"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{table}

\caption{\label{tab:unnamed-chunk-17}Ten taxi pick-up zones with the highest percent tip with threshold equals to 90000}
\centering
\begin{tabular}[t]{r|r|r|r|l|l}
\hline
LocationID & avg\_tip & num\_trips & avg\_dis & Borough & Zone\\
...
\NormalTok{to_jfk_trip <-}\StringTok{ }\NormalTok{yellow_}\FloatTok{2016.}\NormalTok{08_cleaned }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(DOLocationID }\OperatorTok{==}\StringTok{ }
\StringTok{    }\DecValTok{132}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(payment_type }\OperatorTok{!=}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(trip_distance }\OperatorTok{>}\StringTok{ }
...
\StringTok{    }\NormalTok{DOLocationID) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{duration =}\NormalTok{ tpep_dropoff_datetime }\OperatorTok{-}\StringTok{ }
\StringTok{    }\NormalTok{tpep_pickup_datetime) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{min =} \KeywordTok{round}\NormalTok{(}\KeywordTok{as.numeric}\NormalTok{(duration)}\OperatorTok{/}\DecValTok{60}\NormalTok{, }
    \DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hour =} \KeywordTok{hour}\NormalTok{(tpep_pickup_datetime))}
\end{Highlighting}
\end{Shaded}
\begin{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{to_lg_trip <-}\StringTok{ }\NormalTok{yellow_}\FloatTok{2016.}\NormalTok{08_cleaned }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(DOLocationID }\OperatorTok{==}\StringTok{ }
\StringTok{    }\DecValTok{138}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(payment_type }\OperatorTok{!=}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(trip_distance }\OperatorTok{>}\StringTok{ }
\StringTok{    }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(fare_amount }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(PULocationID }\OperatorTok{!=}\StringTok{ }
\StringTok{    }\NormalTok{DOLocationID) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{duration =}\NormalTok{ tpep_dropoff_datetime }\OperatorTok{-}\StringTok{ }
\StringTok{    }\NormalTok{tpep_pickup_datetime) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{min =} \KeywordTok{round}\NormalTok{(}\KeywordTok{as.numeric}\NormalTok{(duration)}\OperatorTok{/}\DecValTok{60}\NormalTok{, }
    \DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hour =} \KeywordTok{hour}\NormalTok{(tpep_pickup_datetime))}

\NormalTok{to_newark_trip <-}\StringTok{ }\NormalTok{yellow_}\FloatTok{2016.}\NormalTok{08_cleaned }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(DOLocationID }\OperatorTok{==}\StringTok{ }
\StringTok{    }\DecValTok{1}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(payment_type }\OperatorTok{!=}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(trip_distance }\OperatorTok{>}\StringTok{ }
\StringTok{    }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(fare_amount }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(PULocationID }\OperatorTok{!=}\StringTok{ }
\StringTok{    }\NormalTok{DOLocationID) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{duration =}\NormalTok{ tpep_dropoff_datetime }\OperatorTok{-}\StringTok{ }
\StringTok{    }\NormalTok{tpep_pickup_datetime) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{min =} \KeywordTok{round}\NormalTok{(}\KeywordTok{as.numeric}\NormalTok{(duration)}\OperatorTok{/}\DecValTok{60}\NormalTok{, }
    \DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hour =} \KeywordTok{hour}\NormalTok{(tpep_pickup_datetime))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{to_jfk_zone <-}\StringTok{ }\NormalTok{to_jfk_trip }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(PULocationID, }
\NormalTok{    hour) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{jfk_avg_min =} \KeywordTok{mean}\NormalTok{(min)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{arrange}\NormalTok{(PULocationID)}

\NormalTok{to_lg_zone <-}\StringTok{ }\NormalTok{to_lg_trip }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(PULocationID, }
\NormalTok{    hour) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{lg_avg_min =} \KeywordTok{mean}\NormalTok{(min)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{arrange}\NormalTok{(PULocationID)}

\NormalTok{to_newark_zone <-}\StringTok{ }\NormalTok{to_newark_trip }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(PULocationID, }
\NormalTok{    hour) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{newark_avg_min =} \KeywordTok{mean}\NormalTok{(min)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{arrange}\NormalTok{(PULocationID)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{two_transp <-}\StringTok{ }\KeywordTok{full_join}\NormalTok{(to_jfk_zone, to_lg_zone, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"PULocationID"}\NormalTok{, }
    \StringTok{"hour"}\NormalTok{))}
\NormalTok{three_transp <-}\StringTok{ }\KeywordTok{full_join}\NormalTok{(two_transp, to_newark_zone, }
    \DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"PULocationID"}\NormalTok{, }\StringTok{"hour"}\NormalTok{))}

\NormalTok{three_transp }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(PULocationID }\OperatorTok{==}\StringTok{ }\DecValTok{4}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{(}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{verbatim}
# A tibble: 5 x 5
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{alphabet <-}\StringTok{ }\NormalTok{three_transp }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(PULocationID }\OperatorTok{==}\StringTok{ }
...
\NormalTok{jfk <-}\StringTok{ }\KeywordTok{plot_ly}\NormalTok{(}\DataTypeTok{x =} \OperatorTok{~}\NormalTok{alphabet}\OperatorTok{$}\NormalTok{hour, }\DataTypeTok{y =} \OperatorTok{~}\NormalTok{alphabet}\OperatorTok{$}\NormalTok{jfk_avg_min, }
    \DataTypeTok{mode =} \StringTok{"lines"}\NormalTok{)}
\NormalTok{jfk}
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/unnamed-chunk-27-1.pdf} As
...
\StringTok{    }\NormalTok{DOLocationID) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{duration =}\NormalTok{ tpep_dropoff_datetime }\OperatorTok{-}\StringTok{ }
\StringTok{    }\NormalTok{tpep_pickup_datetime) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{min =} \KeywordTok{round}\NormalTok{(}\KeywordTok{as.numeric}\NormalTok{(duration)}\OperatorTok{/}\DecValTok{60}\NormalTok{, }
    \DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{hour =} \KeywordTok{hour}\NormalTok{(tpep_pickup_datetime)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(min }\OperatorTok{<=}\StringTok{ }\DecValTok{300}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(min }\OperatorTok{>}\StringTok{ }\DecValTok{1}\NormalTok{)}
...
According to the plot above, it takes the least time to travel to JFK
Airport around 2am in the morning, and it takes the most time around 3pm
in the afternoon.
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lg <-}\StringTok{ }\KeywordTok{plot_ly}\NormalTok{(}\DataTypeTok{x =} \OperatorTok{~}\NormalTok{alphabet}\OperatorTok{$}\NormalTok{hour, }\DataTypeTok{y =} \OperatorTok{~}\NormalTok{alphabet}\OperatorTok{$}\NormalTok{lg_avg_min, }
    \DataTypeTok{mode =} \StringTok{"lines"}\NormalTok{)}
\NormalTok{lg}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{newark <-}\StringTok{ }\KeywordTok{plot_ly}\NormalTok{(}\DataTypeTok{x =} \OperatorTok{~}\NormalTok{alphabet}\OperatorTok{$}\NormalTok{hour, }\DataTypeTok{y =} \OperatorTok{~}\NormalTok{alphabet}\OperatorTok{$}\NormalTok{newark_avg_min, }
    \DataTypeTok{mode =} \StringTok{"lines"}\NormalTok{)}
\NormalTok{newark}
\end{Highlighting}
\end{Shaded}
...
No trace type specified:
  ...
  Read more about this trace type -> https://plot.ly/r/reference/#scatter
\end{verbatim}
\includegraphics{thesis_files/figure-latex/unnamed-chunk-32-1.pdf} As
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{taxi_summary_}\DecValTok{2017}\NormalTok{ <-}\StringTok{ }\NormalTok{taxi }\OperatorTok{%>%}\StringTok{ }\KeywordTok{tbl}\NormalTok{(}\StringTok{"yellow"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{year =} \KeywordTok{year}\NormalTok{(tpep_pickup_datetime), }
    \DataTypeTok{month =} \KeywordTok{month}\NormalTok{(tpep_pickup_datetime)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(year, }
\NormalTok{    month) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{N =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{collect}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
\begin{verbatim}
...
\end{verbatim}
\begin{verbatim}
Warning in .local(conn, statement, ...): Decimal MySQL column 11 imported
as numeric
\end{verbatim}
\begin{verbatim}
...
\end{verbatim}
\begin{verbatim}
Warning in .local(conn, statement, ...): Decimal MySQL column 14 imported
as numeric
\end{verbatim}
\begin{verbatim}
Warning in .local(conn, statement, ...): Decimal MySQL column 15 imported
as numeric
\end{verbatim}
\begin{verbatim}
Warning in .local(conn, statement, ...): Decimal MySQL column 16 imported
as numeric
\end{verbatim}
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{taxi_sum <-}\StringTok{ }\NormalTok{taxi_summary_}\DecValTok{2017} \OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{year_month =} \KeywordTok{paste0}\NormalTok{(year, }
    \StringTok{"-"}\NormalTok{, stringr}\OperatorTok{::}\KeywordTok{str_pad}\NormalTok{(month, }\DecValTok{2}\NormalTok{, }\StringTok{"left"}\NormalTok{, }\StringTok{"0"}\NormalTok{), }\StringTok{"-01"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{time =} \KeywordTok{as.POSIXct}\NormalTok{(year_month))}

\KeywordTok{library}\NormalTok{(plotly)}
\NormalTok{p <-}\StringTok{ }\KeywordTok{plot_ly}\NormalTok{(}\DataTypeTok{x =} \OperatorTok{~}\NormalTok{taxi_sum}\OperatorTok{$}\NormalTok{time, }\DataTypeTok{y =} \OperatorTok{~}\NormalTok{taxi_sum}\OperatorTok{$}\NormalTok{N, }\DataTypeTok{mode =} \StringTok{"lines"}\NormalTok{)}
\NormalTok{p}
\end{Highlighting}
\end{Shaded}
\begin{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# jfk_trip <- taxi %>% tbl('yellow') %>%}
\CommentTok{# filter(RatecodeID == 2) %>% collect()}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{data}\NormalTok{(}\StringTok{"taxi_zone_lookup"}\NormalTok{)}
\NormalTok{to_jfk <-}\StringTok{ }\NormalTok{jfk_trip }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(DOLocationID }\OperatorTok{==}\StringTok{ }\DecValTok{132}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{est_fare =} \FloatTok{2.5} \OperatorTok{+}\StringTok{ }\FloatTok{0.5} \OperatorTok{*}\StringTok{ }\NormalTok{trip_distance }\OperatorTok{*}\StringTok{ }\DecValTok{5} \OperatorTok{+}\StringTok{ }
\StringTok{        }\NormalTok{extra }\OperatorTok{+}\StringTok{ }\NormalTok{improvement_surcharge }\OperatorTok{+}\StringTok{ }\NormalTok{mta_tax }\OperatorTok{+}\StringTok{ }\NormalTok{tolls_amount) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{est_diff =}\NormalTok{ est_fare }\OperatorTok{-}\StringTok{ }\NormalTok{fare_amount) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{LocationID =}\NormalTok{ PULocationID) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{left_join}\NormalTok{(taxi_zone_lookup, }\DataTypeTok{by =} \StringTok{"LocationID"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(Borough }\OperatorTok{==}\StringTok{ "Manhattan"}\NormalTok{)}

\NormalTok{to_jkf_zone <-}\StringTok{ }\NormalTok{to_jfk }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(LocationID) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{num_trips =} \KeywordTok{n}\NormalTok{(), }\DataTypeTok{avg_est_fare =} \KeywordTok{mean}\NormalTok{(est_fare), }
        \DataTypeTok{avg_est_diff =} \KeywordTok{mean}\NormalTok{(est_diff)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{left_join}\NormalTok{(taxi_zone_lookup, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{to_jkf_fare <-}\StringTok{ }\KeywordTok{merge}\NormalTok{(taxi_zones, to_jkf_zone, }\DataTypeTok{by.x =} \StringTok{"LocationID"}\NormalTok{, }
    \DataTypeTok{by.y =} \StringTok{"LocationID"}\NormalTok{)}

\CommentTok{# leaflet(data = to_jkf_fare) %>% addTiles() %>%}
\CommentTok{# addPolygons(fillColor = ~reds(avg_est_fare),}
\CommentTok{# fillOpacity = 0.6, weight = 1, opacity = 0.8) %>%}
\CommentTok{# setView(lat = 40.7128, lng = -74.0060, zoom = 10)}
\end{Highlighting}
\end{Shaded}
\includegraphics{figure/to_jfk_fare.png} According to the map, trips
from Midtown on average cost less than trips from other taxi zones in
Manhattan.
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{to_jkf_zone_above <-}\StringTok{ }\NormalTok{to_jkf_zone }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(avg_est_fare }\OperatorTok{>}\StringTok{ }
\StringTok{    }\DecValTok{52}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(avg_est_fare))}

\KeywordTok{kable}\NormalTok{(to_jkf_zone_above[}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{, ], }\DataTypeTok{caption =} \StringTok{"Ten pick-up zones with the highest avergae fare from Manhattan to JKF Airport"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\begin{table}

\caption{\label{tab:unnamed-chunk-39}Ten pick-up zones with the highest avergae fare from Manhattan to JKF Airport}
\centering
\begin{tabular}[t]{r|r|r|r|l|l}
\hline
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{to_jkf_fare_above <-}\StringTok{ }\KeywordTok{merge}\NormalTok{(taxi_zones, to_jkf_zone_above, }
    \DataTypeTok{by.x =} \StringTok{"LocationID"}\NormalTok{, }\DataTypeTok{by.y =} \StringTok{"LocationID"}\NormalTok{)}

\CommentTok{# leaflet(data = to_jkf_fare_above) %>% addTiles()}
\CommentTok{# %>% addPolygons(fillColor = ~reds(avg_est_fare),}
\CommentTok{# fillOpacity = 0.6, weight = 1, opacity = 0.8) %>%}
\CommentTok{# setView(lat = 40.7128, lng = -74.0060, zoom = 10)}

\CommentTok{# add t test to test average fare vs 52}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{from_jfk <-}\StringTok{ }\NormalTok{yellow_}\FloatTok{2016.}\NormalTok{08_cleaned }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(PULocationID }\OperatorTok{==}\StringTok{ }
\StringTok{    }\DecValTok{132}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(payment_type }\OperatorTok{!=}\StringTok{ }\DecValTok{3}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(trip_distance }\OperatorTok{>}\StringTok{ }
\StringTok{    }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(fare_amount }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(PULocationID }\OperatorTok{!=}\StringTok{ }
...
\StringTok{    }\NormalTok{mta_tax }\OperatorTok{+}\StringTok{ }\NormalTok{tolls_amount) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{est_diff =}\NormalTok{ est_fare }\OperatorTok{-}\StringTok{ }
...
[1] 46.89639
\end{verbatim}
On average, taxi drivers would be paid for \$46.90 for a trip from the
JFK Airport to any taxi zone. What are the most popular drop-off zones
for yellow taxis from JFK Airport?
\begin{Shaded}
\begin{Highlighting}[]
...
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{num_trips =} \KeywordTok{n}\NormalTok{(), }\DataTypeTok{avg_est_fare =} \KeywordTok{mean}\NormalTok{(est_fare), }
        \DataTypeTok{avg_est_diff =} \KeywordTok{mean}\NormalTok{(est_diff)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{LocationID =}\NormalTok{ DOLocationID) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{left_join}\NormalTok{(taxi_zone_lookup, }\DataTypeTok{by =} \StringTok{"LocationID"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# leaflet(data = from_jkf_fare) %>% addTiles() %>%}
\CommentTok{# addPolygons(fillColor = ~reds(avg_est_fare),}
\CommentTok{# fillOpacity = 0.6, weight = 1, opacity = 0.8) %>%}
\CommentTok{# setView(lat = 40.7128, lng = -74.0060, zoom = 10)}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{from_jkf_zone }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Manhattan =} \KeywordTok{ifelse}\NormalTok{(Borough }\OperatorTok{==}\StringTok{ }
\StringTok{    "Manhattan"}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(Manhattan) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{all_trips =} \KeywordTok{sum}\NormalTok{(num_trips))}
\end{Highlighting}
\end{Shaded}
\begin{verbatim}
# A tibble: 2 x 2
