...
\caption{\label{tab:unnamed-chunk-94}Ten pick-up zones with the highest avergae fare from Manhattan to JFK Airport}
\centering
...
\caption{\label{tab:unnamed-chunk-104}Number of Trips going to Manhattan or other boroughs from JFK Airport}
\centering
\begin{tabular}[t]{cc}
\toprule
...
\caption{\label{tab:unnamed-chunk-106}10 most popular taxi drop-off zones from JFK Airport with the corresponding average fare amount}
\centering
\begin{tabular}[t]{ccccc}
\toprule
