...
\caption{\label{tab:unnamed-chunk-45}Ten taxi zones with the highest number of pick-ups}
\centering
\begin{tabular}[t]{ccccc}
\toprule
avg\_tip & avg\_dis & avg\_duration & Borough & Zone\\
...
\caption{\label{tab:unnamed-chunk-47}Ten taxi pick-up zones with the highest percent tip (taxi zones has at least 1 pick-up per hour)}
\centering
\begin{tabular}[t]{ccccc}
\toprule
avg\_tip & avg\_dis & avg\_duration & Borough & Zone\\
...
\caption{\label{tab:unnamed-chunk-49}Ten taxi pick-up zones with the highest percent tip (taxi zones has at least 1 pick-up per minute)}
\centering
\begin{tabular}[t]{ccccc}
\toprule
avg\_tip & avg\_dis & avg\_duration & Borough & Zone\\
...
We found which taxi zone have passengers who offer the highest percent
of tip. We are able to help passengers to know the average time it takes
to go to one of the three airports in New York City so that passengers
can plan their trips accordingly. We also found that the \$52 flat rate
...
would need to pay without the flat rate.
