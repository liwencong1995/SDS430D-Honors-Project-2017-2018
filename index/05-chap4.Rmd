# New York City Taxi Fare & Limousine Commission {#chapter4}
...
kable(to_jkf_zone_above[1:44,], caption = "Pick-up Zones that woulde have paid more than $52")
```
...
from_jkf_zone_above <- from_jkf_zone %>%
  ...
  #filter(avg_fare >= 52) %>%
  arrange(desc(avg_fare))
kable(to_jkf_zone_above[1:67,], caption = "Drop-off Zones that woulde have paid more than $52")
```
