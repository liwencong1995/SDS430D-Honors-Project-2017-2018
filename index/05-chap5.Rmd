...
### People departing from Manhattan benefit from the $52 flat rate
...
## However, are taxi drivers happy when a passenger wants to go to JFK Airport from Manhattan?
...
```{r, message=FALSE, echo=FALSE}
kable(from_jkf_zone[1:10,c(3, 5:7)], 
      caption = "Ten most popular destinations in Manhattan",
      format = "latex",
      align = 'c', 
      escape = TRUE,
      booktabs = TRUE)
...
```{r from-jkf-fare-est, fig.cap="Zones that cost more than the 52 US Dollar flat rate", fig.align='center', echo=FALSE}
...
#### Hourly fare rate for taxi drivers going from Manhattan to JFK airport
