...
to_jfk_fare_above <- leaflet(data = to_jkf_fare_above) %>%
  addTiles() %>%
  addPolygons(fillColor = ~reds(avg_est_fare),
              fillOpacity = 0.6,
              weight = 1,
...
saveWidget(num_trip, file = "/Users/priscilla/Desktop/Honors Thesis/writing/figures/to_jfk_fare_above.html")
URL <- "/Users/priscilla/Desktop/Honors Thesis/writing/figures/to_jfk_fare_above.html"
webshot(URL, "figure/to_jfk_fare_above.png", cliprect = "viewport")


#add t test to test average fare vs 52
```

```{r num-to_jfk_fare_above, fig.cap="Number of Pick-ups in Each Taxi Zone", fig.align='center', echo=FALSE, fig.width=6, fig.height=6, echo=FALSE}
knitr::include_graphics("figure/to_jfk_fare_above.png")
```
