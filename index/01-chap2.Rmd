...
```{r a-report, fig.cap="NYC Taxi & Limousine Commission Aggregated Reports", fig.align='center', echo=FALSE}
...
```{r, fig.cap="MySQL View: yellow_old_sum", fig.align='center', echo=FALSE, echo=FALSE}
