...
```{r, fig.align='center', echo=FALSE, fig.width=6, fig.height=6}
knitr::include_graphics("figure/nyctaxi-page.png")
```
...
```{r map, fig.cap="NYC Taxi Zone Map", fig.align='center', echo=FALSE, fig.width=6, fig.height=6}
knitr::include_graphics("figure/zonemap.png")
```
...
```{r num-trips-summary, fig.cap="Summary of Number of trips Made by 4 Types of Transportations between 2014 and 2016 in NYC, ", fig.align='center', echo=FALSE, fig.width=6, fig.height=6}
knitr::include_graphics("figure/Num_trips_summary.png")
```
