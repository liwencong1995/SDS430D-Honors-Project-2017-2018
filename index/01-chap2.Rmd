...
This package inherits functions from many packages: `etl`[@pkgetl], `dplyr` [@pkgdplyr], `DBI` [@pkgDBI], `rlang` [@pkgrlang], `lubridate` [@pkglubridate], `leaflet` [@pkgleaflet], and `stringr` [@pkgstringr]. 
