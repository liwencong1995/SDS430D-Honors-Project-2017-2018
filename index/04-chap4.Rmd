...
```{r three_air, message=FALSE, echo=FALSE}
...
```{r shinyapp, fig.caption = "Shiny App: Average Number of Minutes Takes to Go to All Three Airports",fig.align='center', echo=FALSE, fig.width=6, fig.height=6}
knitr::include_graphics("figure/shinyapp.png")
```
...
```{r uber-weekly-data, message=FALSE, echo=FALSE}
...
```{r yellow-weekly-data, message=FALSE, echo=FALSE}
