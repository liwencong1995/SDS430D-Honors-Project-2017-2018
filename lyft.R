...
taxi %>%
  etl_extract(years = 2015:2017, months = 1:12, types = c("yellow"), transportation = "lyft") %>% 
  etl_transform(years = 2015:2017, months = 1:12, types = c("yellow"), transportation = "lyft") %>% 
